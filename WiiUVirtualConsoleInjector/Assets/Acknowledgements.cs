...
public static class Acknowledgements
{
    ...
    public static readonly IReadOnlyList<Acknowledgement> Shipped = new Acknowledgement[]
    {
        ...
        new("Genesis Plus GX", "Charles MacDonald, Eke-Eke and the libretro contributors", "The emulator behind the Genesis Plus GX and Genesis Plus GX Wide cores; also serves Sega CD, Master System and Game Gear.", new Uri("https://github.com/libretro/Genesis-Plus-GX"), "Non-commercial"),
        ...
        new("PokeMini", "justburn and the libretro contributors", "The Pokémon Mini emulator behind the PokeMini core.", new Uri("https://github.com/libretro/PokeMini"), "GPL"),
        new("Beetle NeoPop", "Mednafen team and the libretro contributors", "The Neo Geo Pocket emulator behind the Beetle NeoPop core.", new Uri("https://github.com/libretro/beetle-ngp-libretro"), "GPL"),
        new("RACE", "Flavor, Judge and the libretro contributors", "The lighter Neo Geo Pocket emulator offered as a core.", new Uri("https://github.com/libretro/RACE"), "GPL"),
        new("Beetle Cygne", "Mednafen team and the libretro contributors", "The WonderSwan emulator behind the Beetle Cygne core.", new Uri("https://github.com/libretro/beetle-wswan-libretro"), "GPL"),
        new("Potator", "Normmatt and the libretro contributors", "The Watara Supervision emulator behind the Potator core.", new Uri("https://github.com/libretro/potator"), "MIT"),
        new("gw-libretro", "leiradel", "The Game & Watch simulator behind the GW core.", new Uri("https://github.com/libretro/gw-libretro"), "GPL"),
        new("Gearcoleco", "Ignacio Sánchez (drhelius)", "The ColecoVision emulator behind the Gearcoleco core.", new Uri("https://github.com/drhelius/Gearcoleco"), "GPL"),
        new("FreeIntv", "David Richardson and the libretro contributors", "The Intellivision emulator behind the FreeIntv core.", new Uri("https://github.com/libretro/FreeIntv"), "GPL"),
        new("O2EM", "Daniel Boris and the libretro contributors", "The Odyssey² emulator behind the O2EM core.", new Uri("https://github.com/libretro/libretro-o2em"), "Artistic License 2.0"),
        new("vecx", "Valavan Manohararajah and the libretro contributors", "The Vectrex emulator behind the vecx core.", new Uri("https://github.com/libretro/libretro-vecx"), "GPL"),
        new("NeoCD", "Xavier Poirier and the libretro contributors", "The Neo Geo CD emulator behind the NeoCD core.", new Uri("https://github.com/libretro/neocd_libretro"), "LGPL"),
        new("DOSBox Pure", "Bernhard Schelling", "The DOS emulator behind the DOSBox Pure core.", new Uri("https://github.com/schellingb/dosbox-pure"), "GPL"),
        new("VICE", "The VICE Team and the libretro contributors", "The Commodore 64 and 128 emulator behind the VICE x64 and x128 cores.", new Uri("https://github.com/libretro/vice-libretro"), "GPL"),
        new("Caprice32", "Ulrich Doewich, Colin Pitrat and the libretro contributors", "The Amstrad CPC emulator behind the Caprice32 core.", new Uri("https://github.com/libretro/libretro-cap32"), "GPL"),
        new("CrocoDS", "Miguel Vanhove and the libretro contributors", "The lighter Amstrad CPC emulator behind the CrocoDS core.", new Uri("https://github.com/libretro/libretro-crocods"), "MIT"),
        new("Fuse", "Philip Kendall and the Fuse team", "The ZX Spectrum emulator behind the Fuse core.", new Uri("https://github.com/libretro/fuse-libretro"), "GPL"),
        new("Hatari", "The Hatari team and the libretro contributors", "The Atari ST emulator behind the Hatari core.", new Uri("https://github.com/libretro/hatari"), "GPL"),
        new("FCEUmm", "The FCEUX team and the libretro contributors", "The NES emulator behind the FCEUmm core, an alternative to the NES Virtual Console base.", new Uri("https://github.com/libretro/libretro-fceumm"), "GPL"),
        new("Nestopia UE", "Martin Freij, Richard Bannister and the libretro contributors", "The NES emulator behind the Nestopia UE core.", new Uri("https://github.com/libretro/nestopia"), "GPL"),
        new("QuickNES", "Shay Green (blargg), Andrew Schaefer and the libretro contributors", "The light NES emulator behind the QuickNES core.", new Uri("https://github.com/libretro/QuickNES_Core"), "LGPL"),
        new("fixNES", "FIX94", "The NES emulator behind the fixNES core.", new Uri("https://github.com/FIX94/fixNES"), "MIT"),
        new("Snes9x", "The Snes9x team and the libretro contributors", "The SNES emulator behind the Snes9x 2002, 2005, 2005 Plus and 2010 cores, an alternative to the SNES Virtual Console base.", new Uri("https://github.com/snes9xgit/snes9x"), "Snes9x licence, non-commercial"),
        new("ChimeraSNES", "jamsilva and the libretro contributors", "The SNES emulator behind the ChimeraSNES core, built on Snes9x 2005.", new Uri("https://github.com/jamsilva/chimerasnes"), "Snes9x licence, non-commercial"),
        new("Gambatte", "sinamas and the libretro contributors", "The Game Boy and Game Boy Color emulator behind the Gambatte core, an alternative to Goomba on the GBA base.", new Uri("https://github.com/libretro/gambatte-libretro"), "GPL"),
        new("Gearboy", "Ignacio Sánchez (drhelius)", "The Game Boy and Game Boy Color emulator behind the Gearboy core.", new Uri("https://github.com/drhelius/Gearboy"), "GPL"),
        new("fixGB", "FIX94", "The Game Boy and Game Boy Color emulator behind the fixGB core.", new Uri("https://github.com/FIX94/fixGB"), "MIT"),
        new("mGBA", "Vicki Pfau (endrift) and the libretro contributors", "The Game Boy Advance emulator behind the mGBA core, an alternative to the GBA Virtual Console base.", new Uri("https://github.com/libretro/mgba"), "MPL 2.0"),
        new("VBA-M", "The VBA-M team and the libretro contributors", "The Game Boy Advance emulator behind the VBA-M and VBA Next cores.", new Uri("https://github.com/libretro/vbam-libretro"), "GPL"),
        new("gpSP", "Exophase, notaz and the libretro contributors", "The light Game Boy Advance emulator behind the gpSP core.", new Uri("https://github.com/libretro/gpsp"), "GPL"),
        new("Beetle PCE", "Mednafen team and the libretro contributors", "The TurboGrafx-16 emulator behind the Beetle PCE, PCE Fast and SuperGrafx cores, an alternative to the TurboGrafx-16 Virtual Console base.", new Uri("https://github.com/libretro/beetle-pce-libretro"), "GPL"),
        new("blueMSX", "Daniel Vik and the libretro contributors", "The MSX emulator behind the blueMSX core, an alternative to the MSX Virtual Console base.", new Uri("https://github.com/libretro/blueMSX-libretro"), "GPL"),
        new("fMSX", "Marat Fayzullin and the libretro contributors", "The MSX emulator behind the fMSX core.", new Uri("https://github.com/libretro/fmsx-libretro"), "fMSX licence, non-commercial"),
