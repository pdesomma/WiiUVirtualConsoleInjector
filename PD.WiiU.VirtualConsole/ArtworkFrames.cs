...
public static class ArtworkFrames
{
    ...
    private static readonly ArtworkFrame[] Known =
    {
        ...
        // Game Boy titles ride on the GBA base and share its art
        Boot("gb-gb", "Game Boy", SourceConsole.GameBoy, "newgameboy.png", BootGbc),
        Boot("gb-gb-grey", "Game Boy, grey", SourceConsole.GameBoy, "Gameboy1.png", BootGbc),
        Boot("gb-gb-green", "Game Boy, green", SourceConsole.GameBoy, "Gameboy2.png", BootGbc),
        Boot("gb-gbc", "Game Boy Color", SourceConsole.GameBoy, "GBC.png", BootGbc),
        Boot("gb-gba", "Game Boy Advance", SourceConsole.GameBoy, "GBA.png", BootGba),
        ...
        Icon("icon-gb-gb-1", "Game Boy, style 1", SourceConsole.GameBoy, "GBalt1.png", IconBadged),
        Icon("icon-gb-gb-2", "Game Boy, style 2", SourceConsole.GameBoy, "GBalt2.png", IconBadged),
        Icon("icon-gb-gbc-1", "Game Boy Color, style 1", SourceConsole.GameBoy, "GBCalt1.png", IconBadged),
        Icon("icon-gb-gbc-2", "Game Boy Color, style 2", SourceConsole.GameBoy, "GBCalt2.png", IconBadged),
        Icon("icon-gb-gba-1", "Game Boy Advance, style 1", SourceConsole.GameBoy, "GBAalt1.png", IconBadged),
        Icon("icon-gb-gba-2", "Game Boy Advance, style 2", SourceConsole.GameBoy, "GBAalt2.png", IconBadged),
